        ...
        <tbody>
            @foreach($data as $item)
                <tr>
                    ...
                    <td class="arabic-text">{{ $item->employee_name ?? 'غير محدد' }}</td>
                    <td class="arabic-text">{{ $item->gender ?? 'غير محدد' }}</td>
                    <td class="arabic-text">{{ $item->ed_level_id ?? 'غير محدد' }}</td>
                    <td class="arabic-text">{{ $item->department_id ?? 'غير محدد' }}</td>
                    <td class="arabic-text">{{ $item->job_title_id ?? 'غير محدد' }}</td>
                    <td class="arabic-text">{{ $item->job_grade_id ?? 'غير محدد' }}</td>
