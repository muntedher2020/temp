                        ...
                        <form wire:submit.prevent="exportData">
                            ...
                            <div class="d-flex gap-2 align-items-center flex-wrap">
                                ...
                                <div class="d-flex gap-2 align-items-center flex-wrap">
                                    ...
                                    <div wire:loading wire:target="exportData" class="flex-grow-1" style="min-width: 300px;">
                                        <div class="alert alert-primary d-flex align-items-center mb-0 py-2" role="alert">
