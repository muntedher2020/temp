<!-- Remove TrainingDomain Modal -->
<div wire:ignore.self class="modal fade" id="removetrainingdomainModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                ...
                <hr class="mt-n2">
                <div wire:loading.remove wire:target="destroy, GetTrainingDomain">
