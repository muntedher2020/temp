                ...
                <div class="d-flex justify-content-between">
                            ...
                            <ol class="breadcrumb breadcrumb-style1 mb-0">
                                ...
                                <li class="breadcrumb-item active fs-4">
                                    <span class="fw-bold text-primary d-flex align-items-center">
                                        ...
                                        <span class="ms-1">التحصيل العلمي</span>
                                    </span>
                                </li>
                            </ol>
                        </nav>
                    ...
                    <div>
                        <div class="d-flex gap-2">
                            ...
                            @if(auth()->user()->can('educationallevel-export-excel') || auth()->user()->can('educationallevel-export-pdf'))
                                <div class="btn-group" role="group">
                                    ...
                                    <ul class="dropdown-menu">
                                        @can('educationallevel-export-excel')
                                            <li>
                                        ...
                                        @endcan
                                        @can('educationallevel-export-pdf')
                                            <li>
                                                <a class="dropdown-item" href="{{ route('EducationalLevels.export.pdf.tcpdf') }}">
                                                    <i class="mdi mdi-file-pdf-box me-2 text-danger"></i>
                                                    تصدير PDF (TCPDF)
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="{{ route('EducationalLevels.print.view') }}" target="_blank">
                            ...
                            @endif
                            @can('educationallevel-create')
                                <button wire:click='AddEducationalLevelModalShow' class="mb-3 add-new btn btn-primary mb-md-0"
                                    data-bs-toggle="modal" data-bs-target="#addeducationallevelModal">أضــافــة</button>
                            @endcan
                        </div>
                        @include('livewire.educational-levels.modals.add-educational-level')
                    </div>
                </div>
            </div>
            @can('educationallevel-list')
                            ...
                            <tr>
                                ...
                                <th class="text-center">
                                        <input type="text" wire:model.debounce.300ms="search.name"
                                            class="form-control text-center" placeholder="التحصيل العلمي"
                        ...
                        <tbody>
                            ...
                            @foreach ($EducationalLevels as $EducationalLevel)
                                <tr>
                                    ...
                                    <td>{{ $i++ }}</td>
                                    <td class="text-center">{{$EducationalLevel->name}}</td>
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="First group">
                                            @can('educationallevel-edit')
                                                <button wire:click="GetEducationalLevel({{$EducationalLevel->id}})"
                                                    class="p-0 px-1 btn btn-text-primary waves-effect" data-bs-toggle="modal"
                                                    data-bs-target="#editeducationallevelModal">
                                                    <i class="mdi mdi-text-box-edit-outline fs-3"></i>
                                                </button>
                                            @endcan
                                            @can('educationallevel-delete')
                                                <strong style="margin: 0 10px;">|</strong>
                                                <button wire:click="GetEducationalLevel({{$EducationalLevel->id}})"
                                                    class="p-0 px-1 btn btn-text-danger waves-effect"
                                                    data-bs-toggle = "modal" data-bs-target="#removeeducationallevelModal">
                ...
                <!-- Modal -->
                @include('livewire.educational-levels.modals.edit-educational-level')
                @include('livewire.educational-levels.modals.remove-educational-level')
                <!-- Modal -->
            @endcan
        </div>
    @else
