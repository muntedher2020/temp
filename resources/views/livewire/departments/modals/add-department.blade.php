                ...
                <div class="mb-4 text-center mt-n4">
                    <div class="text-center mb-4">
                        <h3 class="fw-bold mb-2">
                            <span class="text-primary">اضافة</span> الاقسام جديد
                        </h3>
                        <p class="text-muted">
                            <i class="mdi mdi-cog me-1"></i>
                            قم بإدخال تفاصيل الاقسام في النموذج أدناه
                        </p>
                    </div>
                </div>
                <hr class="mt-n2">
                            ...
                            <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='name' type="text"
                                                id="modalDepartmentname" placeholder="اسم القسم"
                                                class="form-control @error('name') is-invalid is-filled @enderror"/>
                                            <label for="modalDepartmentname">اسم القسم</label>
                                        </div>
                                        @error('name')
