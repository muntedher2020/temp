                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <div class="d-flex gap-2">
                            ...
                            @if(auth()->user()->can('department-export-excel') || auth()->user()->can('department-export-pdf'))
                                <div class="btn-group" role="group">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        @endcan
                                        @can('department-export-pdf')
                                            <li>
                                                <a class="dropdown-item" href="{{ route('Departments.export.pdf.tcpdf') }}">
                                                    <i class="mdi mdi-file-pdf-box me-2 text-danger"></i>
                                                    تصدير PDF (TCPDF)
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="{{ route('Departments.print.view') }}" target="_blank">
                            ...
                            <tr>
                                ...
                                <th class="text-center">
                                        <input type="text" wire:model.debounce.300ms="search.name"
                                            class="form-control text-center" placeholder="اسم القسم"
