...
@section('page-script')
    ...
    <script>
        ...
        window.addEventListener('JobGradeModalShow', event => {
            setTimeout(() => {
                $('#id').focus();
            }, 100);
        })
        ...
        window.addEventListener('success', event => {
            ...
            $('#editjobgradeModal').modal('hide');
            $('#removejobgradeModal').modal('hide');
