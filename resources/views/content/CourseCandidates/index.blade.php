...
@section('title', 'المتدربين والمرشحين')
...
@section('content')
    ...
    @livewire('course-candidates.course-candidate')
...
@section('page-script')
    ...
    <script>
        ...
        window.addEventListener('CourseCandidateModalShow', event => {
            setTimeout(() => {
                $('#id').focus();
            }, 100);
        })
        ...
        window.addEventListener('success', event => {
            $('#addcoursecandidateModal').modal('hide');
            $('#editcoursecandidateModal').modal('hide');
            $('#removecoursecandidateModal').modal('hide');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('#addcoursecandidateModal').on('shown.bs.modal', function () {
            setTimeout(() => {
                initSelect2ForModal('#addcoursecandidateModal');
            }, 100);
        });

        // Initialize for edit modal
        $('#editcoursecandidateModal').on('shown.bs.modal', function () {
            setTimeout(() => {
                initSelect2ForModal('#editcoursecandidateModal');
            }, 100);
        });
        ...
        document.addEventListener('livewire:load', function() {
            window.livewire.hook('message.processed', (message, component) => {
                setTimeout(function() {
                    if ($('#addcoursecandidateModal').hasClass('show')) {
                        // Destroy and reinitialize
                        $('#addcoursecandidateModal select').each(function() {
                    ...
                    if ($('#editcoursecandidateModal').hasClass('show')) {
                        // Destroy and reinitialize
                        $('#editcoursecandidateModal select').each(function() {
                            if ($(this).hasClass('select2-hidden-accessible')) {
                                $(this).select2('destroy');
                            }
                        });
        ...
        $('#addcoursecandidateModal, #editcoursecandidateModal').on('hidden.bs.modal', function () {
