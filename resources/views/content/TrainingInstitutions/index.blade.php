...
@section('content')
    ...
    @livewire('training-institutions.training-institution')
...
@section('page-script')
    ...
    <script>
        ...
        window.addEventListener('TrainingInstitutionModalShow', event => {
            setTimeout(() => {
                $('#id').focus();
            }, 100);
        })
        ...
        window.addEventListener('success', event => {
            $('#addtraininginstitutionModal').modal('hide');
            $('#edittraininginstitutionModal').modal('hide');
            $('#removetraininginstitutionModal').modal('hide');
