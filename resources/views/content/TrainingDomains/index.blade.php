...
@section('content')
    ...
    @livewire('training-domains.training-domain')
...
@section('page-script')
    ...
    <script>
        ...
        window.addEventListener('TrainingDomainModalShow', event => {
            setTimeout(() => {
                $('#id').focus();
            }, 100);
        })
        ...
        window.addEventListener('success', event => {
            $('#addtrainingdomainModal').modal('hide');
            $('#edittrainingdomainModal').modal('hide');
            $('#removetrainingdomainModal').modal('hide');
