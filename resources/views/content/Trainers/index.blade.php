...
@section('page-script')
    ...
    <script>
        ...
        window.addEventListener('TrainerModalShow', event => {
            setTimeout(() => {
                $('#id').focus();
            }, 100);
        })
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('#addtrainerModal').on('shown.bs.modal', function () {
            setTimeout(() => {
                initSelect2ForModal('#addtrainerModal');
            }, 100);
        });

        // Initialize for edit modal
        $('#edittrainerModal').on('shown.bs.modal', function () {
            setTimeout(() => {
                initSelect2ForModal('#edittrainerModal');
            }, 100);
        });
        ...
        document.addEventListener('livewire:load', function() {
            window.livewire.hook('message.processed', (message, component) => {
                setTimeout(function() {
                    if ($('#addtrainerModal').hasClass('show')) {
                        // Destroy and reinitialize
                        $('#addtrainerModal select').each(function() {
                    ...
                    if ($('#edittrainerModal').hasClass('show')) {
                        // Destroy and reinitialize
                        $('#edittrainerModal select').each(function() {
                            if ($(this).hasClass('select2-hidden-accessible')) {
                                $(this).select2('destroy');
                            }
                        });
        ...
        $('#addtrainerModal, #edittrainerModal').on('hidden.bs.modal', function () {
