...
@section('content')
    ...
    @livewire('educational-levels.educational-level')
...
@section('page-script')
    ...
    <script>
        ...
        window.addEventListener('EducationalLevelModalShow', event => {
            setTimeout(() => {
                $('#id').focus();
            }, 100);
        })
        ...
        window.addEventListener('success', event => {
            $('#addeducationallevelModal').modal('hide');
            $('#editeducationallevelModal').modal('hide');
            $('#removeeducationallevelModal').modal('hide');
