...
@section('page-script')
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('#addcourseModal').on('shown.bs.modal', function () {
            setTimeout(() => {
                initSelect2ForModal('#addcourseModal');
            }, 100);
        });
        ...
        $('#editcourseModal').on('shown.bs.modal', function () {
            setTimeout(() => {
                initSelect2ForModal('#editcourseModal');
            }, 100);
        });
            ...
            window.livewire.hook('message.processed', (message, component) => {
                setTimeout(function() {
                    if ($('#addcourseModal').hasClass('show')) {
                        ...
                        $('#addcourseModal select').each(function() {
                    ...
                    if ($('#editcourseModal').hasClass('show')) {
                        // Destroy and reinitialize
                        $('#editcourseModal select').each(function() {
                            if ($(this).hasClass('select2-hidden-accessible')) {
                                $(this).select2('destroy');
                            }
                        });
