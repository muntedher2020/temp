...
class TrainingInstitutionTcpdfExportController extends Controller
{
    ...
    /**
     * Export PDF for TrainingInstitutions using TCPDF
     */
    public function exportPdf()
    {
        try {
            ...
            $pdf->SetTitle('تقرير مؤسسة المدرب');
            $pdf->SetSubject('تقرير شامل لـ مؤسسة المدرب');
            ...
            $pdf->setRTL(true);
            $pdf->Cell(0, 15, 'تقرير مؤسسة المدرب', 0, 1, 'C');
            $pdf->Ln(5);
            ...
            $pdf->Cell(170, 10, 'اسم المؤسسة', 1, 1, 'C', 1);
            ...
            return $pdf->Output('تقرير_مؤسسة المدرب_' . now()->format('Y_m_d_H_i_s') . '.pdf', 'D');
