...
class JobTitleTcpdfExportController extends Controller
{
    ...
    /**
     * Export PDF for JobTitles using TCPDF
     */
    public function exportPdf()
    {
        try {
            ...
            $pdf->SetTitle('تقرير العنوان الوظيفي');
            $pdf->SetSubject('تقرير شامل لـ العنوان الوظيفي');
            ...
            $pdf->setRTL(true);
            $pdf->Cell(0, 15, 'تقرير العنوان الوظيفي', 0, 1, 'C');
            $pdf->Ln(5);
            ...
            $pdf->Cell(170, 10, 'العنوان الوظيفي', 1, 1, 'C', 1);
            ...
            return $pdf->Output('تقرير_العنوان الوظيفي_' . now()->format('Y_m_d_H_i_s') . '.pdf', 'D');
