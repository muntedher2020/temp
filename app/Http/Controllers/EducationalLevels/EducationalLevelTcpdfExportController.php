...
class EducationalLevelTcpdfExportController extends Controller
{
    ...
    /**
     * Export PDF for EducationalLevels using TCPDF
     */
    public function exportPdf()
    {
        try {
            ...
            $pdf->SetTitle('تقرير التحصيل العلمي');
            $pdf->SetSubject('تقرير شامل لـ التحصيل العلمي');
            ...
            $pdf->setRTL(true);
            $pdf->Cell(0, 15, 'تقرير التحصيل العلمي', 0, 1, 'C');
            $pdf->Ln(5);
            ...
            $pdf->Cell(170, 10, 'التحصيل العلمي', 1, 1, 'C', 1);
            ...
            return $pdf->Output('تقرير_التحصيل العلمي_' . now()->format('Y_m_d_H_i_s') . '.pdf', 'D');
